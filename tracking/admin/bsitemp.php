...
<body>
  ...
  <div class="top_banner">
    <div class="in_banner">
            <div class=" logo">
                <img alt="" src="../admin/image//banner.png" style="width: 100%;">
                </div>
    ...
    <div class="middle" style="margin-left:25%;">
        ...
        <button class="btn btn-primary">
            <b>  <a href="admin_it.php"style="color:white;"><i class="fas fa-users"></i>BSIT Alumni</a></b>
        </button>
        
            <button class="btn btn-dark">
                <b>   <a href="admin_cs.php"style="color:skyblue;" ><i class="fas fa-job"> </i>BSCS Alumni</a></b>
            </button>
...
<form>
  ...
  <thead>
    <tr>
      ...
      <th class="text-lg-center">Organization</th>
      <th class="text-lg-center">profession</th>
     <th class="text-lg-center">Employement Type</th>
     <th class="text-lg-center">Location</th>
      <th class="text-lg-center">Job Situation</th>
       <th class="text-lg-center">Num. of years in work</th>
     <th class="text-lg-center">Month. Income</th>
