...
if(isset($_POST['input'])){
    ...
    $query = "SELECT * FROM bscsgrad WHERE fullname LIKE '{$input}%' OR age LIKE '{$input}%' OR cs LIKE '{$input}%' OR sex LIKE '{$input}%' OR course LIKE '{$input}%' OR batch LIKE '{$input}%' OR estatus LIKE '{$input}%'";
