...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name_error_err) && empty($types_error) && empty($parts_error) && empty($description_error) ) {
          $sql = " INSERT INTO plants (`name`,`types`,`parts`,`description`) VALUES ('$Oregano', '$Herbs', '$Leaf,Stem', '$Used to flavor foods'), ('$Calachuchi', '$Flowers', '$Cloves,Stigma', '$For making a perfume which had a scent similar to these flowers'), ( '$Lagundi', '$Herbs', '$Leaf,Stem', '$Used to treat insect and snake bites,ulcers,rheumatism,sore throat,cough,fever'), ( '$Eggplants', '$Vegetables', '$Stem,leaf', '$Used as a $vegetable in cooking' ) 
